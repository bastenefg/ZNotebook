...
7. Add the hosted app URL as an authorized JavaScript origin.
8. Copy the Client ID.

If the OAuth consent screen asks for app URLs, use the hosted app URL as the application home page and `https://YOUR_HOSTED_APP_URL/privacy.html` as the privacy policy URL. The repository also includes `PRIVACY.md` with the same content for review.
